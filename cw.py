...
oids=['40928776','40928079','40927304','40877785','40870193','40870151','40927048','41029161']
pages = 30
	...
	for oid in oids:
		...
		for page in range(1, pages+1):
			...
			for retry in range(0,5):
				try:
					response = requests.get('https://api.bilibili.com/x/v2/reply?&jsonp=jsonp&pn='+str(page)+'&type=11&oid='+oid+'&sort=0&_=1562316459358', timeout=5)
			...
			if success:
				...
				try:
					...
					for comment in responselist:
						...
						ctime = comment['ctime']
						if (ctime not in ctime2uid or ctime2uid[ctime] != uid): #防止因为爬取期间有人评论导致重复爬取
							ctime2uid[ctime] = uid
